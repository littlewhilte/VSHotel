              ...
              <ul class="of" id="bna">
                <li>
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      <img
                        src="~/assets/photo/views/天安门.png"
                ...
                <li>
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      <img
                        src="~/assets/photo/views/水立方.jpeg"
                        class="img-responsive"
                        alt="水立方"
                      >
                      <div class="cc-mask">
                ...
                <li>
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      <img
                        src="~/assets/photo/views/圆明园.jpeg"
                        class="img-responsive"
                        alt="圆明园"
                      >
                      <div class="cc-mask">
                ...
                <li>
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      <img
                        src="~/assets/photo/views/颐和园.jpeg"
                        class="img-responsive"
                        alt="颐和园"
                      >
                      <div class="cc-mask">
                ...
                <li>
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      <img
                        src="~/assets/photo/views/北海公园.jpeg"
                        class="img-responsive"
                        alt="北海公园"
                      >
                      <div class="cc-mask">
                ...
                <li>
                  <div class="cc-l-wrap">
                    <section class="course-img">
                      <img
                        src="~/assets/photo/views/南锣古巷.jpeg"
                        class="img-responsive"
                        alt="南锣古巷"
                      >
                      <div class="cc-mask">
...
data () {
  ...
  methods :{
    ...
    //   index.getIndexData()
    //   .then(reponse=>{
    //     this.viewList = reponse.data.data.list
    //   })
    // }
  }
}
